...
public class UploadImageService {
    ...
    public void uploadImage(final Activity activity, String userId, File file, final RESTClientResponse restClientResponse) {
        //File
        ...
        Call<EmptyResponse> call = Utils.getInstance().getRestClient().uploadImage(body, userIdBody);
